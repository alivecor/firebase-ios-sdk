...
Simplify your app development, grow your user base, and monetize more effectively with Firebase.
  ...
  s.subspec 'CoreOnly' do |ss|
    ss.dependency 'FirebaseCore', '10.24.1'
  ...
  s.subspec 'ABTesting' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseABTesting', '~> 10.24.1'
  ...
  s.subspec 'AppCheck' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseAppCheck', '~> 10.24.1'
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
    ss.watchos.deployment_target = '6.0'
  ...
  s.subspec 'Auth' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseAuth', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  ...
  s.subspec 'Crashlytics' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseCrashlytics', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  ...
  s.subspec 'Database' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseDatabase', '~> 10.24.1'
  ...
  s.subspec 'DynamicLinks' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.ios.dependency 'FirebaseDynamicLinks', '~> 10.24.1'
    ss.ios.deployment_target = '11.0'
  end

  s.subspec 'Firestore' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseFirestore', '~> 10.24.1'
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  end
  ...
  s.subspec 'Functions' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseFunctions', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  ...
  s.subspec 'Installations' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseInstallations', '~> 10.24.1'
  end

  s.subspec 'Messaging' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseMessaging', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  ...
  s.subspec 'Performance' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.ios.dependency 'FirebasePerformance', '~> 10.24.1'
    ss.tvos.dependency 'FirebasePerformance', '~> 10.24.1'
    ss.ios.deployment_target = '11.0'
    ss.tvos.deployment_target = '12.0'
  end
  ...
  s.subspec 'RemoteConfig' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseRemoteConfig', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
  ...
  s.subspec 'Storage' do |ss|
    ss.dependency 'Firebase/CoreOnly'
    ss.dependency 'FirebaseStorage', '~> 10.24.1'
    # Standard platforms PLUS watchOS.
    ss.ios.deployment_target = '11.0'
    ss.osx.deployment_target = '10.13'
    ss.tvos.deployment_target = '12.0'
